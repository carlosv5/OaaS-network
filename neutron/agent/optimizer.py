...
class OptimizerDriver(object):
    """Optimizer Driver base class.

    Defines methods that any driver providing security groups
    and provider optimizer functionality should implement.
    ...
    def apply_port_filter(self, port):
        ...
        Once this method returns, the port should be optimizered
...
class NoopOptimizerDriver(OptimizerDriver):
    """Noop Optimizer Driver.

    Optimizer driver which does nothing.
    This driver is for disabling the optimizer functionality.
    """
