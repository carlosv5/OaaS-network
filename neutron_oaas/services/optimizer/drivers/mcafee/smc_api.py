...
from neutron_oaas.services.optimizer.drivers.mcafee import constants as const
...
class SMCAPIElement(object):
    """
    Base class of elements, used by L2/L3 single optimizer class
    """
    element_type = "N/A"
...
class SMCAPIElementL2FWSingle(SMCAPIElement):
    ...
    def create(self):
        ...
        json_data[const.JSON_NODES][0]['optlayer2_node']['name'] = (self.name +
                                                                   " node 1")
...
class SMCAPIElementL3FWSingle(SMCAPIElement):
    """L3 single optimizer element."""
    element_type = "single_opt"
    ...
    def create(self):
        ...
        json_data[const.JSON_LOG_SERVER_REF] = log_server_ref
        json_data[const.JSON_NAME] = self.name
        json_data[const.JSON_NODES][0]['optimizer_node']['name'] = (self.name +
                                                                   " node 1")
