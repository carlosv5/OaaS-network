...
class TestVyattaUtils(base.BaseTestCase):
    ...
    def test_get_optimizer_name(self):
        ...
        opt_name = vyatta_utils.get_optimizer_name(
            None, fake_optimizer)

        self.assertEqual(opt_name, '74bc106dfff04f92ac1a60d4b6b4')
    ...
    def test_get_zone_cmds(self):
        optimizer_name = 'fake_optimizer0'
        eth_iface = 'eth0'
        ...
        cmds_actual = vyatta_utils.get_zone_cmds(
            fake_api, fake_apply_rule, optimizer_name)
        cmds_expect = [
            ...
            vyatta_client.SetCmd(
                vyatta_utils.ZONE_OPTIMIZER_CMD.format(
                    trusted_zone_name, untrusted_zone_name,
                    parse.quote_plus(optimizer_name))),
            vyatta_client.SetCmd(
                vyatta_utils.ZONE_OPTIMIZER_CMD.format(
